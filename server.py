...
SYSTEM_PROMPTS = {
    "parse": "你是一个营养分析助手。用户会输入一段饮食文本，包含餐段和食物。请解析并返回JSON数组，每项一个餐段，格式为 {\"meal\": \"餐名\", \"foods\": [{\"name\": \"食物名\", \"weight_g\": 克数, \"calories\": 千卡, \"protein_g\": 克, \"fat_g\": 克, \"carbs_g\": 克}]}。所有营养值为每100g数据乘以实际克数后的估算值。只返回JSON数组，不要其他文字。不确定的食物按常识估算。",
